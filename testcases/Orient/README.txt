...
>> python download_pixc_pixcvec.py -d [xxx]/download_pixc_dir -prod SWOT_L2_HR_PIXC SWOT_L2_HR_PIXCVEC -pass 264 69 Right -c PIC0 -conv 1

For the code FPDEM, the PIXC files are stored in the directory: testcase_Orient/input/pixc (The path can be defined in the FPDEM script parameters file SWOT_Param_L2_HR_FPDEM_20250324T000000_Orient.rdf)

#
# Parameters file

The parameters file SWOT_Param_L2_HR_FPDEM_20250324T000000_Orient.rdf is located in the testcase directory.
...
>> python [xxx]/floodplain/scripts/process_full_processing_floodplain.py [xxx]/floodplain/run/testcase_Orient/SWOT_Param_L2_HR_FPDEM_20250324T000000_Orient.rdf
