...
Testcase including the lakes Tele, Fati and Oro as well as a piece of the Niger river.

#
# PIXC

Tiles covering the area or part of it: 363_183L  460_126L
...
>> python download_pixc_pixcvec.py -d [xxx]/download_pixc_dir -prod SWOT_L2_HR_PIXC -pass 363 183 Left -c PIC0 -conv 1

For the code FPDEM, the PIXC files are stored in the directory: .[..]/Tele/input/pixc (The path should be defined in the FPDEM script parameters file SWOT_Param_L2_HR_FPDEM_Tele.rdf)

Some cycles seem to be bad or will cause issues for the FPDEM bathymetry extraction:
For tile 363_183L: 7, 11, 21, 13, 24, 25, 26
For tile 460_126L: 12, 21

#
# Parameters file

The parameters file SWOT_Param_L2_HR_FPDEM_Tele.rdf is located in the testcase directory.
...
>> python [xxx]/floodplain_dem/scripts/process_full_processing_floodplain.py [xxx]/floodplain_dem/testcases/Tele/SWOT_Param_L2_HR_FPDEM_Tele.rdf
