...
For the code FPDEM, the PIXC files are stored in the directory: .[..]/Barotse/input/pixc (The path should be defined in the FPDEM script parameters file SWOT_Param_L2_HR_FPDEM_Barotse.rdf)

#
# Parameters file

The parameters file SWOT_Param_L2_HR_FPDEM_Barotse.rdf is located in the testcase directory.
...
>> python [xxx]/floodplain_dem/scripts/process_full_processing_floodplain.py [xxx]/floodplain_dem/testcases/Barotse/SWOT_Param_L2_HR_FPDEM_Barotse.rdf
