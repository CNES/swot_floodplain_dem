Congo - Mbamu islan / Pool Malebo testcase:

#
# PIXC

Tiles covering the area or part of it: 570_162L
...
>> python download_pixc_pixcvec.py -d [xxx]/download_pixc_dir -prod SWOT_L2_HR_PIXC -pass 570 162 Left -c PIC0 -conv 1

For the code FPDEM, the PIXC files are stored in the directory: .[..]/Congo/input/pixc (The path should be defined in the FPDEM script parameters file SWOT_Param_L2_HR_FPDEM_Congo.rdf)

Some cycles seem to be bad or will cause issues for the FPDEM bathymetry extraction:
For tile 570_162L: 6, 10, 12, 14, 15, 16, 20, 22, 24, 26, 29, 30, 31, 36 (here, lots of Dark Water notably on the west part of the river)

#
# Parameters file

The parameters file SWOT_Param_L2_HR_FPDEM_Congo.rdf is located in the testcase directory.
...
>> python [xxx]/floodplain_dem/scripts/process_full_processing_floodplain.py [xxx]/floodplain_dem/testcases/Congo/SWOT_Param_L2_HR_FPDEM_Congo.rdf
