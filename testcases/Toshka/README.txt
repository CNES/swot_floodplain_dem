...
Tiles covering the area or part of it: 277_196L  # and also 277_195L 040_114R but they do not cover the same region!
...
>> python download_pixc_pixcvec.py -d [xxx]/download_pixc_dir -prod SWOT_L2_HR_PIXC -pass 277 196 Left -c PIC0 -conv 1

For the code FPDEM, the PIXC files are stored in the directory: .[..]/Toshka/input/pixc (The path should be defined in the FPDEM script parameters file SWOT_Param_L2_HR_FPDEM_Toshka.rdf)

Some cycles seem to be bad or will cause issues for the FPDEM bathymetry extraction:
For tile 277_196L: 18, 20, 30

#
# Parameters file

The parameters file SWOT_Param_L2_HR_FPDEM_Toshka.rdf is located in the testcase directory.
0
#
...
>> python [xxx]/floodplain_dem/scripts/process_full_processing_floodplain.py [xxx]/floodplain_dem/testcases/Toshka/SWOT_Param_L2_HR_FPDEM_Toshka.rdf
